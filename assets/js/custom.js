(function () {
  ...
  var app = {
    ...
    appendBtnTop: function () {
      $("body").append(
        '<div class="btn-top"><svg class="btn-icon-right" viewBox="0 0 13 9" width="13" height="9"><i class="fa fa-arrow-up scrollUp" aria-hidden="true"></i></svg></div>'
      );
    },
    ...
    MainMenuCloseNotEl: function (e) {
      if ($("body").hasClass("mmm-open")) {
        if ($(e.originalEvent.target).closest(".mmm, .main-mnu-btn").length)
          return;
